...
fn bench_prover_circuit1a(c: &mut Criterion){
    ...
    let mut group = c.benchmark_group("marlin-tweedle_dee-test circuit 1a-variable constraints-segment_size=num_constraints");
...
fn bench_prover_circuit1b(c: &mut Criterion){
    ...
    let mut group = c.benchmark_group("marlin-tweedle_dee-test circuit 1b-variable constraints-segment_size=num_constraints");
...
fn bench_prover_circuit1c(c: &mut Criterion){
    ...
    let mut group = c.benchmark_group("marlin-tweedle_dee-test circuit 1c-variable constraints-segment_size=num_constraints");
...
fn bench_prover_circuit2a(c: &mut Criterion){
    ...
    let mut group = c.benchmark_group("marlin-tweedle_dee-test circuit 2a-variable constraints-segment_size=num_constraints");
...
fn bench_prover_circuit2b(c: &mut Criterion){
    ...
    let mut group = c.benchmark_group("marlin-tweedle_dee-test circuit 2b-variable constraints-segment_size=num_constraints");
...
fn bench_prover_circuit2c(c: &mut Criterion){
    ...
    let mut group = c.benchmark_group("marlin-tweedle_dee-test circuit 2c-variable constraints-segment_size=num_constraints");
